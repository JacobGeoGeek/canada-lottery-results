...
from .entities.detail_breakdown import DetailBreakDown
from .entities.bonus_draw import BonusDraw
...
def find_daily_grand_results_by_years(year: int) -> list[Result]:
